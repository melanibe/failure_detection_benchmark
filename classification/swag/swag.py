"""
Code taken from https://github.com/wjmaddox/swa_gaussian/blob/master/swag/posteriors/swag.py
"""
...
from classification.swag.utils import flatten, unflatten_like
...
class SWAG(torch.nn.Module):
    ...
    def import_numpy_weights(self, w):
        ...
        for module, name in self.params:
            ...
            module.__setattr__(
                name, mean.new_tensor(w[k:(k + s)].reshape(mean.shape))
            )
            k += s
